        ...
        <section className="py-32 relative overflow-hidden flex justify-center items-center bg-brand-dark border-t border-brand-border transition-colors duration-300">
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
            ...
            <button
              ...
              className="bg-brand-text text-brand-dark hover:bg-brand-neon transition-all duration-300 px-10 py-4 rounded-lg font-bold text-base tracking-wide shadow-lg hover:shadow-brand-neon/20 hover:scale-105 active:scale-95"
            >
